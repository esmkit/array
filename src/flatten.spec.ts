...
describe("flatten", () => {
  ...
  it("should flatten a deeply nested array to the specified depth", () => {
    ...
    expect(flatten(originArr, Number.POSITIVE_INFINITY)).toEqual(expectedArr3);
    expect(originArr.flat(Number.POSITIVE_INFINITY)).toEqual(expectedArr3);
  });
  ...
  it("should return the same array if depth is 0 or NaN or negative", () => {
    ...
    expect(flatten(originArr, Number.NaN)).toEqual(expectedArr);
    expect(originArr.flat(Number.NaN)).toEqual(expectedArr);
